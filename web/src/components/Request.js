...
export default function Request() {
  ...
  const getAccepted = async () => {
    try {
      const response = await axios.get(
        `http://localhost:4000/api/request/accepted`
      );
      console.log("Response Data:", response.data);
      const responseData = response.data;
        ...
        <div className="desicion-box-left">
          ...
          <div className="vehicle-detail">
            <div className="detail-boxes">
              ...
              <div className="info" style={{ marginLeft: "12px", borderRight: "none" }}>
  ...
  return (
    <div className="container-request">
      ...
      <div className="request-details">
        ...
        <div className="map">
          <Directions startLocation={{ coordinates: [80.540379, 5.949636] }} endLocation={{ coordinates: [80.55, 5.959] }} />
        </div>
