      ...
      <div className="field-container">
            ...
            >
              <div class="accordion-body">
                <p>
                  ...
                  Wrench it. By accessing or using this system, you agree to be
                  bound by the terms and conditions outlined herein.
                </p>
                <ul>
                  <li>
                    <strong>License Grant:</strong> You are granted a license to
                    use the Vehicle Breakdown System for managing breakdown
                    services.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Restrictions:</strong> Prohibited actions including
                    modification, reverse engineering, or transferring the
                    Software.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Support and Maintenance:</strong> Wrench it provides
                    reasonable technical support for the Software.
                  </li>
                  <li>
        ...
        <div class="form-check">
          ...
          <label class="form-check-label" for="flexCheckChecked">
            ...
            abide by the terms and conditions of the Vehicle Breakdown System
          </label>
        </div>
      </div>
      <br />
